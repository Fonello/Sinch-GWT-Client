...
public class JsoHelper {
    ...
    public static native JavaScriptObject[] getAttributeAsJavaScriptObjectArray(JavaScriptObject elem, String attr) /*-{
		...
		return (arrayJS === undefined) ? null
				: @com.sinch.client.jso.JsoHelper::toArray(Lcom/google/gwt/core/client/JavaScriptObject;)(arrayJS);
    }-*/;
    ...
    public static native void setAttribute(JavaScriptObject elem, String attr, Function handler) /*-{
		elem[attr] = function() {
			handler.@com.sinch.client.jso.Function::execute()();
		};
    }-*/;
    ...
    public static native Date getAttributeAsDate(JavaScriptObject elem, String attr) /*-{
                                                                                   var ret = elem[attr];
                                                                                   return (ret === undefined || ret == null) ? null: @com.sinch.client.jso.JsoHelper::toDate(D)(ret.getTime());
                                                                                   }-*/;
    ...
    public static native String[] getProperties(JavaScriptObject jsObj) /*-{
		var props = @com.sinch.client.jso.JsoHelper::createJavaScriptArray()();
		for ( var k in jsObj) {
			props.push(k);
		}
		return @com.sinch.client.jso.JsoHelper::convertToJavaStringArray(Lcom/google/gwt/core/client/JavaScriptObject;)(props);
    }-*/;
